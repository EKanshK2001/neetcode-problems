...
* we keep track of new elements encountered (or a valid substring) using a set 
*
* left pointer is actually a reference for the left corner of a substring and will also be used to calculate current length
*
